...
export async function POST(request) {
  try {
    ...
    console.log('Messages to mark as read:', messageIds); // Log message IDs
    ...
    console.error('Error marking emails as read:', error); // Log error
